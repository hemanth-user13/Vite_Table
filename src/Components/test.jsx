...
function Home() {
    ...
    const fetchData = async () => {
        try {
            const response1 = await axios.get('http://localhost:8001/amazon');
            const response2 = await axios.get('http://localhost:8001/flipkart');
            const response3 = await axios.get('http://localhost:8001/cellbay');
            const response4 = await axios.get('http://localhost:8001/snapStore');
                    ...
                    <table className="min-w-full bg-white border">
                        <thead>
                            <tr className="bg-gray-200">
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Product Dealer</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Product Locations</th>
                        ...
                        <tbody>
                            {data.map((item, index) => (
                                <tr key={index} className="bg-white border-b">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{item.Location_availability}</td>
                                    <td className="">
                                        <button
